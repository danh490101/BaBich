                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr class="alert" role="alert">
                                ...
                                <td>
                                    <div class="email">
                                        <span>Kem Chống Nắng COCOON</span>
                            ...
                            <tr class="alert" role="alert">
                                ...
                                <td>
                                    <div class="img" style="background-image: url(asset/images/pd7.jpg);"></div>
                                </td>
                                <td>
                                    <div class="email">
                                        <span>Kem Dưỡng Đêm Klairs</span>
                                    </div>
                                </td>
                                <td>360.000đ</td>
                                <td class="quantity">
                            ...
                            <!-- <tr class="alert" role="alert">
                                ...
                                <td>
                                    <div class="img" style="background-image: url(asset/images/prod-4.jpg);"></div>
                                </td>
                                <td>
                                    <div class="email">
                                        <span>Jim Beam Kentucky Straight</span>
                            ...
                            <!-- <tr class="alert" role="alert">
                                ...
                                <td class="border-bottom-0">
                                    <div class="img" style="background-image: url(asset/images/prod-5.jpg);"></div>
                                </td>
                                <td class="border-bottom-0">
                                    <div class="email">
                                        <span>Jim Beam Kentucky Straight</span>
