            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <li class="nav-item dropdown">
                        <a class="nav-link pr-0" href="{{route('admin.category.add')}}" role="button">
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a class="dropdown-item" href="chinh-sua-loai-hang.php ?>">Xem & chỉnh sửa</a>
                                            <a class="dropdown-item" href="chinh-sua-loai-hang.php">Xóa</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
