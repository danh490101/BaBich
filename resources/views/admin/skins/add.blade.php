        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0"> Thêm phân loại da</h6>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="Tên tình trạng da" value="">
                            ...
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-6 text-left">
                                        <div class="form-group">
                                            <a href="{{route('admin.skins.index')}}" class="btn btn-sm btn-outline-primary">Quay lại</a>
                                        </div>
                                    </div>
                                    <div class="col-6 text-right">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-sm btn-primary">  Thêm phân loại da </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
