                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <span class="text-warning" data-toggle="tooltip" data-placement="left" title="Thông tin bắt buộc nhập">(*)</span>
                                        <input type="text" name="id-goods" class="form-control" placeholder="Loại hàng" value="{{$product -> category_id}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <span class="text-warning" data-toggle="tooltip" data-placement="left" title="Thông tin bắt buộc nhập">(*)</span>
                                        <input type="text" name="id-goods" class="form-control" placeholder="Thương hiệu" value="{{$product -> brand_id}}">
                                        <!-- <select class="form-control form-select mt-3" name='brand_id' placeholder="Loại hàng">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="desc" rows="4" class="form-control" placeholder="Mô tả chi tiết sản phẩm" value="{{$product->desc}}"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
