        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Chỉnh sửa thông tin nhà cung cấp</h6>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-800 bg-opacity-90">
                        ...
                        @endif
                        <form action="{{ route('admin.suppliers.update', ['supplier' => $supplier->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="Tên sản phẩm" value="{{$supplier->name}}">
                                            @error('name')
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" class="form-control" placeholder="Email nhà cung nhấp" value="{{$supplier->email}}">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <span class="text-warning" data-toggle="tooltip" data-placement="left" title="Thông tin bắt buộc nhập">(*)</span>
                                            <input type="text" name="phone" class="form-control" placeholder="Số điện thoại" value="{{$supplier->phone}}">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <span class="text-warning" data-toggle="tooltip" data-placement="left" title="Thông tin bắt buộc nhập">(*)</span>
                                            <input type="text" name="address" class="form-control" placeholder="Địa chỉ" value="{{$supplier->address}}">
                                            @error('name')
                                            <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
