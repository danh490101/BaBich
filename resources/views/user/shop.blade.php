					...
					<div class="sidebar-box ftco-animate">
						<div class="categories">
							...
							<ul class="p-0">
								...
								<li><a href="{{ route('user.shop', ['brandId' => $brand->id, 'categoryId' => Request::get('categoryId')]) }}">{{$brand->name}}<span class="fa fa-chevron-right"></span></a></li>
								@else
								...
								<div class="img d-flex align-items-center justify-content-center" style="background-image: url({{asset('storage/'.$product->image)}});">
									<div class="desc">
										<p class="meta-prod d-flex">
											<a href="{{route('add_to_cart_get',['id' => $product->id])}}" class="d-flex align-items-center justify-content-center"><span class="flaticon-shopping-bag"></span></a>
