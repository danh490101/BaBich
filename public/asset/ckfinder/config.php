...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/path/to/ckfinder/userfiles/',
    'root'         => '/absolute/path/to/userfiles/',
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
$config['types']['Files'][] = 'htm';
$config['types']['Files'][] = 'html';
$config['types']['Files'][] = 'php';
$config['types']['Files'][] = 'xml';
$config['types']['Files'][] = 'js';
$config['types']['Files'][] = 'css';
$config['types']['Files'][] = 'pdf';
